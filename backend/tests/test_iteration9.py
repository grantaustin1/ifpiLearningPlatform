...
class TestAlembic:
    ...
    def test_current_head(self):
        ...
        assert any(h in out for h in ("a9c2470b8e15", "b3d8915cef27", "c4f9826dfe44", "d5f0a3bc7e91", "e7a3b9c4d816")), f"out={r.stdout} err={r.stderr}"
    ...
    def test_downgrade_one_then_upgrade(self):
        ...
        assert any(h in (r3.stdout + r3.stderr) for h in ("a9c2470b8e15", "b3d8915cef27", "c4f9826dfe44", "d5f0a3bc7e91", "e7a3b9c4d816"))
