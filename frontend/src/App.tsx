...
const AdminCertificatesPage = lazy(() => import('pages/dashboard/AdminCertificatesPage'))
...
const OutboxPage = lazy(() => import('pages/dashboard/OutboxPage'))
const OrganizationSettingsPage = lazy(() => import('pages/dashboard/OrganizationSettingsPage'))
const AcademiesPage = lazy(() => import('pages/dashboard/AcademiesPage'))
const AuditLogPage = lazy(() => import('pages/dashboard/AuditLogPage'))
const BadgeTiersPage = lazy(() => import('pages/dashboard/BadgeTiersPage'))
const WebhooksPage = lazy(() => import('pages/dashboard/WebhooksPage'))
const ImportsPage = lazy(() => import('pages/dashboard/ImportsPage'))
const ApiTokensPage = lazy(() => import('pages/dashboard/ApiTokensPage'))
const ResearchPage = lazy(() => import('pages/dashboard/ResearchPage'))
const FlashcardsAuthoringPage = lazy(() => import('pages/dashboard/FlashcardsAuthoringPage'))
const LearnerFlashcardsPage = lazy(() => import('pages/learn/LearnerFlashcardsPage'))
const MindMapPage = lazy(() => import('pages/dashboard/MindMapPage'))
...
const CourseDetailPage = lazy(() => import('pages/catalog/CourseDetailPage'))
const QueryBuilderPage = lazy(() => import('pages/dashboard/QueryBuilderPage'))
const ScheduledReportsPage = lazy(() => import('pages/dashboard/ScheduledReportsPage'))
const EmailDiagnosticsPage = lazy(() => import('pages/dashboard/EmailDiagnosticsPage'))
...
const FeedbackAdminPage = lazy(() => import('pages/dashboard/FeedbackAdminPage'))
const PreferencesPage = lazy(() => import('pages/dashboard/PreferencesPage'))
const Erp360IntegrationsPage = lazy(() => import('pages/dashboard/Erp360IntegrationsPage'))
const EntitlementsInspectorPage = lazy(() => import('pages/dashboard/EntitlementsInspectorPage'))
const WebhookDeliveriesPage = lazy(() => import('pages/dashboard/WebhookDeliveriesPage'))
